...
module.exports.powershell = function(script, paramsAsString) {
	...
	**/
	...
	exec(command, function(error, stdout, stderr) {
		...
		if (error) {
			Gkn.Common.log('exec returned error: ', { success: false, status: 400, caller: 'function.js>powershell', data: stderr });
			return { success: false, status: 400, caller: 'function.js>powershell', data: stderr }
		}

		Gkn.Common.debuglog({ success: true, status: 200, caller: 'function.js>powershell', data: stdout });
